      ...
      {(() => {
        ...
        return (
          <>
            ...
            <div className='mt-8'>
              <h3 className='text-lg font-semibold text-center text-red-600 md:text-xl'>
                {WEEKLY_CALORIES_BURNED}
              </h3>
            ...
            <div className='mt-8'>
              <h3 className='text-lg font-semibold text-center text-purple-600 md:text-xl'>
                {MONTHLY_CALORIES_BURNED}
              </h3>
              <p className='text-sm text-center text-gray-500'>
            ...
            <div className='mt-8'>
              <h3 className='text-lg font-semibold text-center text-orange-600 md:text-xl'>
                {YEARLY_CALORIES_BURNED}
              </h3>
              <p className='text-sm text-center text-gray-500'>
